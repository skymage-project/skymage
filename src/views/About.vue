<template>
  <div>
    <div>
      <v-app-bar color="#6A76AB" prominent src="https://j.gifs.com/L73vD4.gif"> </v-app-bar>
    </div>
    <div class="w3-container w3-content w3-padding-64" style="max-width: 800px; color: orange" id="contact">
      <h1 class="w3-wide w3-center">Please feel free to reach out to us with your questions and comments.</h1>
