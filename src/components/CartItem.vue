<template>
  <div>
    <v-card width="100%">
      <v-img :src="addedItem.picture" class="white--text align-end" gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)" height="200px">
        <v-card-title>{{ addedItem.name.length > 20 ? addedItem.name.slice(0, 20) + "..." : addedItem.name }}</v-card-title>
      </v-img>
